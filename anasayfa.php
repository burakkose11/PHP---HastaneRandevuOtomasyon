...
<body>
  ...
  <div class="orta_div" id="randevu_div">
    <form action="islem.php" method="post">
      ...
      <select name="hastane" class="hastane" id="">
        <option value="hastane">Hastane Seçin</option>
        <option value="Acıbadem Hastanesi">Acıbadem Hastanesi</option>
        <option value="Bölge Eğitim ve Araştırma Hastanesi">
          Bölge Eğitim ve Araştırma Hastanesi
        </option>
        <option value="Bilecik Devlet Hastanesi">
          Bilecik Devlet Hastanesi
        </option>
        <option value="Bozüyük Devlet Hastanesi">
          Bozüyük Devlet Hastanesi
        </option>
        <option value="Ümit Hastanesi">Ümit Hastanesi</option>
      </select>
      ...
      <select name="doktor" class="doktor" id="">
  ...
  <div class="orta_div" id="ailehekimi_div">
    <h3>Aile Hekimi</h3>
    <p>Aile Hekiminize Ait Bir Çalışma Saati Bulunmamıştır.</p>
  </div>
</body>
